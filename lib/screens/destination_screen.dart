...
import 'package:msafiri/screens/destination_model.dart';
    ...
    return Scaffold(
      body: Column(
        children: <Widget>[
              ...
              Container(
                ...
                child: Hero(
                  ...
                  child: ClipRRect(
                    ...
                    child: Image(
                      image: AssetImage(
                          widget.destination.imageUrl), // *check later
                      fit: BoxFit
                          .cover, //allows image to fit the child completely
                    ),
                  ),
                ),
              ),
          ...
          Expanded(
            // allows the expanding of the Listview widget because the height is not specified
                ...
                return Stack(
                  children: <Widget>[
                    Container(
                      ...
                      height: 170.0,
                      width: double
                          .infinity, //allows expanding of the image as per the container
                      decoration: BoxDecoration(
                        color: Colors.white,
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            Row(
                              mainAxisAlignment: MainAxisAlignment
                                  .spaceBetween, //btwn the price and the destination
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: <Widget>[
                                Container(
                                  width: 120.0,
                              ...
                              children: <Widget>[
                                ...
                                Container(
                                  padding: EdgeInsets.all(
                                      5.0), //allows the text container to have more space
                                  width: 70.0,
                                  decoration: BoxDecoration(
                                    color: Theme.of(context).accentColor,
                                    borderRadius: BorderRadius.circular(10.0),
